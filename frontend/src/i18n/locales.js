...
export const LOCALES = {
  en: {
    ...
    "edit.crop": "Crop",
    "edit.cropDone": "Done",
    "edit.cropHint": "Drag the frame to move it, the corners to resize, outside it to rotate; ← → rotate 15° at a time. The frame keeps the photo's proportions. C or Esc exits.",
  ...
  "pt-br": {
    ...
    "edit.cropHint": "Arraste o quadro para mover, os cantos para redimensionar e fora dele para girar; ← → giram de 15 em 15°. O quadro mantém a proporção da foto. C ou Esc sai.",
