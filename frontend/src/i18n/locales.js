...
export const LOCALES = {
  en: {
    ...
    "layers.hint": "Paint over the object to extract it. Each stroke adds to the selection; Subtract (or holding Alt) removes. S or Enter finishes, Esc cancels.",
  ...
  "pt-br": {
    ...
    "layers.hint": "Pinte por cima do objeto para extraí-lo. Cada traço soma à seleção; Subtrair (ou segurar Alt) remove. S ou Enter conclui, Esc cancela.",
